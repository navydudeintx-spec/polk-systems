      ...
      <section className="relative pt-48 pb-20 z-10">
        <Container>
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="text-brand-accent text-[10px] font-black tracking-[0.4em] uppercase mb-8 block">
              Project Inquiry
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5 space-y-px bg-white/10 border border-white/10">
              <div className="p-10 bg-brand-black group">
                <span className="text-brand-accent text-[8px] font-black uppercase tracking-widest mb-6 block">
                  Direct_Relay_01
                </span>
                <h3 className="text-xl font-black uppercase mb-4 group-hover:text-brand-accent transition-colors">
                  Email Channel
                </h3>
                <a
                  href="mailto:polk@polk-systems.com"
